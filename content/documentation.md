		...
		<header id="header" class="static-sticky">
			...
			<div id="header-wrap">
				...
				<div class="container-fullwidth clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="one-page/images/canvasone-dark.png"><img src="images/canvashelp.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="one-page/images/canvasone-dark@2x.png"><img src="images/canvashelp@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu">
						...
						<ul>
							<li><a href="http://themeforest.net/user/SemiColonWeb/portfolio?ref=SemiColonWeb"><div>Themes</div></a></li>
							<li><a href="http://themeforest.net/item/canvas-the-multipurpose-html5-template/9228123/support/contact?ref=SemiColonWeb"><div>Contact</div></a></li>
						</ul>
			...
			<div class="content-wrap nopadding">
				...
				<div id="docs" class="container-fullwidth clearfix">
					...
					<div class="docs-navigation">
						...
						<ul>
							<li><a href="#docs-start">Start</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-start-installation">Installation<!-- <span class="label label-danger">New</span> --></a></li>
									<li><a href="#" data-href="#docs-start-html">HTML Structure</a></li>
									<li><a href="#" data-href="#docs-start-pagetransition">Page Transition</a></li>
									<li><a href="#" data-href="#docs-start-logo">Logo Settings</a></li>
									<li><a href="#" data-href="#docs-start-color">Color Schemes</a></li>
									<li><a href="#" data-href="#docs-start-fonts">Changing Fonts</a></li>
									<li><a href="#" data-href="#docs-start-custom">Customization</a></li>
									<li><a href="#" data-href="#docs-start-rtl">RTL Setup</a></li>
									<li><a href="#" data-href="#docs-start-less">LESS Setup</a></li>
									<li><a href="#" data-href="#docs-start-tips">Optimization Tips</a></li>
									<!-- <li><a href="#" data-href="#docs-start-update">Updating Canvas</a></li> -->
								</ul>
							</li>
							<li><a href="#docs-upgrading">Upgrade v3 to v4</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-upgrading-css">CSS</a></li>
									<li><a href="#" data-href="#docs-upgrading-php">PHP</a></li>
									<li><a href="#" data-href="#docs-upgrading-html">HTML</a></li>
								</ul>
							</li>
							<li><a href="#docs-headers">Headers</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-headers-types">Header Types</a></li>
									<li><a href="#" data-href="#docs-headers-megamenu">Mega Menus</a></li>
									<li><a href="#" data-href="#docs-headers-menustyles">Menu Styles</a></li>
									<li><a href="#" data-href="#docs-headers-mobilemenu">Mobile Menu</a></li>
									<li><a href="#" data-href="#docs-headers-submenu">Page Sub Menu</a></li>
									<li><a href="#" data-href="#docs-headers-dotsmenu">Dots Sub Menu</a></li>
									<li><a href="#" data-href="#docs-headers-helper">Helper Classes</a></li>
								</ul>
							</li>
							<li><a href="#docs-pageel">Page Elements</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-pageel-titles">Page Title</a></li>
									<li><a href="#" data-href="#docs-pageel-grid">Grid</a></li>
									<li><a href="#" data-href="#docs-pageel-isotope">Isotope Grid</a></li>
									<li><a href="#" data-href="#docs-pageel-sidepanel">Side Panel</a></li>
									<li><a href="#" data-href="#docs-pageel-gototop">Go To Top</a></li>
									<li><a href="#" data-href="#docs-pageel-classes">Helper Classes</a></li>
									<li><a href="#" data-href="#docs-pageel-snippets">Useful Snippets</a></li>
								</ul>
							</li>
							<li><a href="#docs-slider">Sliders</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-slider-types">Types &amp; Options</a></li>
									<li><a href="#" data-href="#docs-slider-canvas">Canvas Slider</a></li>
									<li><a href="#" data-href="#docs-slider-captions">Captions</a></li>
									<li><a href="#" data-href="#docs-slider-classes">Helper Classes</a></li>
								</ul>
							</li>
							<li><a href="#docs-blog">Blog</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-blog-setup">Setup</a></li>
									<li><a href="#" data-href="#docs-blog-posttypes">Post Types</a></li>
									<li><a href="#" data-href="#docs-blog-comments">Comments</a></li>
								</ul>
							</li>
							<li><a href="#docs-portfolio">Portfolio</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-portfolio-setup">Setup</a></li>
									<li><a href="#" data-href="#docs-portfolio-pageajax">In Page AJAX</a></li>
									<li><a href="#" data-href="#docs-portfolio-modalajax">Modal AJAX</a></li>
									<li><a href="#" data-href="#docs-portfolio-infinity">Infinity Scroll</a></li>
								</ul>
							</li>
							<li><a href="#docs-shortcodes">Shortcodes</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-shortcodes-intro">Introduction</a></li>
									<li><a href="#" data-href="#docs-shortcodes-animations">Animations</a></li>
									<li><a href="#" data-href="#docs-shortcodes-sections">Sections &amp; Parallax</a></li>
									<li><a href="#" data-href="#docs-shortcodes-tabs">Tabs &amp; Accordions</a></li>
									<li><a href="#" data-href="#docs-shortcodes-slider">Responsive Slider</a></li>
									<li><a href="#" data-href="#docs-shortcodes-owl">Owl Carousel</a></li>
									<li><a href="#" data-href="#docs-shortcodes-lightbox">Lightbox &amp; Notifications</a></li>
									<li><a href="#" data-href="#docs-shortcodes-modalonload">Modals on Load</a></li>
									<li><a href="#" data-href="#docs-shortcodes-gmap">Google Maps</a></li>
									<li><a href="#" data-href="#docs-shortcodes-countdown">Countdown</a></li>
									<li><a href="#" data-href="#docs-shortcodes-icons">Icons</a></li>
								</ul>
							</li>
							<li><a href="#docs-widgets">Widgets</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-widgets-setup">Setup</a></li>
									<li><a href="#" data-href="#docs-widgets-flickr">Flickr</a></li>
									<li><a href="#" data-href="#docs-widgets-dribbble">Dribbble</a></li>
									<li><a href="#" data-href="#docs-widgets-instagram">Instagram</a></li>
									<li><a href="#" data-href="#docs-widgets-twitter">Twitter Feed</a></li>
									<li><a href="#" data-href="#docs-widgets-contact">Contact &amp; Subscriptions</a></li>
								</ul>
							</li>
							<li><a href="#docs-credits">Credits</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-credits-images">Images</a></li>
									<li><a href="#" data-href="#docs-credits-jquery">jQuery</a></li>
									<li><a href="#" data-href="#docs-credits-css">CSS</a></li>
									<li><a href="#" data-href="#docs-credits-php">PHP</a></li>
								</ul>
							</li>
							<li><a href="#docs-changelog">Changelog</a>
								<ul class="one-page-menu" data-offset="110" data-easing="easeInOutExpo" data-speed="1250">
									<li><a href="#" data-href="#docs-changelog-v4-1">Version 4.1</a></li>
									<li><a href="#" data-href="#docs-changelog-v4">Version 4.0</a></li>
									<li><a href="#" data-href="#docs-changelog-v3-1">Version 3.1</a></li>
									<li><a href="#" data-href="#docs-changelog-v3">Version 3.0</a></li>
									<li><a href="#" data-href="#docs-changelog-v2-5">Version 2.5</a></li>
									<li><a href="#" data-href="#docs-changelog-v2-1">Version 2.1</a></li>
									<li><a href="#" data-href="#docs-changelog-v2">Version 2.0</a></li>
									<li><a href="#" data-href="#docs-changelog-v1-4">Version 1.4</a></li>
									<li><a href="#" data-href="#docs-changelog-v1-3">Version 1.3</a></li>
									<li><a href="#" data-href="#docs-changelog-v1-2">Version 1.2</a></li>
									<li><a href="#" data-href="#docs-changelog-v1-1">Version 1.1</a></li>
									<li><a href="#" data-href="#docs-changelog-v1">Version 1.0</a></li>
								</ul>
							</li>
						</ul>
...
<pre class="bottommargin">&lt;body class="stretched"&gt;</pre>
								...
								<p class="bottommargin">Canvas enables Smooth Scrolling on Windows Desktop PCs for a Smooth Experience. You can disable it by simply adding the <code>.no-smooth-scroll</code> Class to the <strong>&lt;body&gt;</strong> Tag.</p>
...
3. &lt;link rel="stylesheet/less" href="less/responsive.less" type="text/less" /&gt;</pre>
									...
									<li>
										<h4>Step 2:</h4>
										<p>Add the LESS Script just after the <code>js/plugins.js</code> Script Linking in your <code>&lt;head&gt;</code> Tag:</p>
...
...</pre>
									...
									<li>All other Minor Changes has been described in the Changelog Section</li>
								</ul>
...
&lt;/div&gt;</pre>
							...
							<div id="docs-headers-helper" class="docs-content-inner page-section">
								...
								You can change the Default header height of <code>100px</code> to any other Height according to your Requirements. Simply use the following CSS Codes:
...
<pre class="bottommargin">&lt;div class="section dark" style="height: 550px;"&gt;
...
&lt;/div&gt;</pre>
							...
							<div id="docs-shortcodes-slider" class="docs-content-inner page-section">
								...
								<p>You can add a Responsive Slider on any Page using the Code below:</p>
...
&lt;/div&gt;</pre>
							...
							<div id="docs-shortcodes-gmap" class="docs-content-inner page-section">
								...
								<ul class="bottommargin">
									<li>
										<h4>Step 1:</h4>
										<p>Add the Google Maps Specific Scripts in the <code>&lt;head&gt;</code> Tag below the <code>js/plugins.js</code> script linking:</p>
<pre>&lt;script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"&gt;&lt;/script&gt;
...
&lt;/script&gt;</pre>
							...
							<div id="docs-shortcodes-icons" class="docs-content-inner page-section" style="position: relative;">
								...
								<div class="input-group" style="width: 250px; position: absolute; top: 7px; left: 150px;">
...
<pre>&lt;div id="instagram-photos" class="instagram-photos masonry-thumbs col-5" data-user="269801886" data-count="15" data-type="user"&gt;&lt;/div&gt;</pre>
